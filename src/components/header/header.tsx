    ...
    <header class="fixed top-0 right-0 left-0 z-50 border-b border-black/10 bg-white/90 backdrop-blur-xl">
      ...
      <div class="relative mx-auto flex h-20 max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
        ...
        <div class="hidden items-center gap-2 lg:flex">
          ...
          <Link
            href="/events"
            class="theta-focus rounded-xl border-2 border-[var(--theta-primary)] bg-[var(--theta-primary)] px-4 py-2 text-sm font-bold text-white shadow-[0_8px_20px_rgba(220, 20, 60,0.35)]"
          >
            Register Now
          </Link>
        </div>
        ...
        >
          ...
          <div class="mt-3 space-y-2.5 border-t border-black/10 pt-3">
            ...
            <Link
              href="/events"
              onClick$={closeMenu}
              class="theta-focus block rounded-xl border-2 border-[var(--theta-primary)] bg-[var(--theta-primary)] px-4 py-3 text-center font-bold text-white shadow-[0_8px_18px_rgba(220, 20, 60,0.28)]"
            >
              Register Now
            </Link>
          </div>
