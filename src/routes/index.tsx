...
> = {
  ...
  media: { chip: "bg-[#fee2e2] text-[#991b1b]", border: "border-[#dc143c]" },
};
          ...
          <div class="relative grid gap-10 lg:grid-cols-[1.15fr_1fr] lg:items-center">
            <div>
              ...
              <div class="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/events"
                  class="theta-focus inline-flex items-center gap-2 rounded-xl border-2 border-[var(--theta-primary)] bg-[var(--theta-primary)] px-6 py-3 text-sm font-bold text-white shadow-[0_10px_22px_rgba(220, 20, 60,0.35)]"
                >
          ...
          <div class="relative grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div>
              ...
              <div class="mt-6 flex flex-wrap gap-3">
                <Link
                  href="/events"
                  class="theta-focus inline-flex items-center justify-center rounded-xl border-2 border-[var(--theta-primary)] bg-[var(--theta-primary)] px-7 py-3 text-sm font-black text-white shadow-[0_10px_22px_rgba(220, 20, 60,0.35)]"
                >
