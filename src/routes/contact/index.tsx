...
export default component$(() => {
  ...
  const TeamCard = ({ member }: { member: TeamMember }) => (
    <article class="theta-panel group relative overflow-hidden border-black/15 bg-white p-5 transition duration-200 hover:[transform:translateY(-6px)_rotate(-0.5deg)]">
      ...
      <div class="relative mx-auto flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border-2 border-black/20 bg-white text-2xl font-black text-neutral-900 shadow-[0_0_0_2px_rgba(17,17,17,0.18)]">
        <img
      ...
      <section class="theta-reveal theta-reveal-delay-2 mt-12 grid gap-5 lg:grid-cols-2">
        ...
        <div class="theta-shell relative overflow-hidden p-6">
          ...
          <div class="relative">
            ...
            <a
              href={`mailto:${teamData.value.webtek.email}`}
              class="theta-focus mt-4 inline-flex rounded-xl border-2 border-[var(--theta-primary)] bg-[var(--theta-primary)] px-5 py-3 text-sm font-bold text-white shadow-[0_8px_20px_rgba(17,17,17,0.24)]"
            >
