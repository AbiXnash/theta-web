    ...
    <div class="min-h-screen bg-gray-950">
      ...
      <div class="relative mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 text-center">
          ...
          <p class="text-slate-400">{eventsPageCopy.value.subtitle}</p>
        </div>
              ...
              <div class="animate-scale-in relative h-[calc(100vh-1rem)] w-full max-w-5xl sm:h-auto">
                ...
                <div class="premium-surface premium-ring relative h-full max-h-[95vh] overflow-y-auto rounded-2xl shadow-[0_25px_90px_rgba(76,29,149,0.45)] sm:max-h-[90vh] sm:rounded-3xl">
                  ...
                  <div class="grid lg:grid-cols-5">
                    ...
                    <div class="relative flex w-full flex-col items-center justify-center overflow-hidden rounded-t-2xl border-b border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(168,85,247,0.3),rgba(15,23,42,0.35),rgba(2,6,23,1))] p-5 text-center sm:p-8 lg:rounded-l-3xl lg:rounded-tr-none lg:border-r lg:border-b-0">
